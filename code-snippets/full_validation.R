...
dev.off()
write.table(data = marker_check, file = paste(subdirs[i],"/results","/marker_information.txt", sep = ""), sep = ',')
...
plot_markers(marker_check)
dev.off()
write.table(data = marker_check, file = paste(subdirs[i],"/results","/marker_invasive_information.txt", sep = ""), sep = ',')
...
plot_markers(marker_check)
dev.off()
write.table(data = marker_check, file = paste(subdirs[i],"/results","/marker_pigmented_information.txt", sep = ""), sep = ',')
...
plot_markers(marker_check)
dev.off()
write.table(data = marker_check, file = paste(subdirs[i],"/results","/marker_smc_information.txt", sep = ""), sep = ',')
...
plot_markers(marker_check)
dev.off()
write.table(data = marker_check, file = paste(subdirs[i],"/results","/marker_ncsc_information.txt", sep = ""), sep = ',')
